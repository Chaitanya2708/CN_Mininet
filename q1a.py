...
def run():
    ...
    # Add static routes for hosts
    net['h1'].cmd('ip route add 172.16.0.0/12 via 192.168.1.1')
    net['h1'].cmd('ip route add 10.0.0.0/8 via 192.168.1.1')

    net['h2'].cmd('ip route add 172.16.0.0/12 via 192.168.1.1')
    net['h2'].cmd('ip route add 10.0.0.0/8 via 192.168.1.1')

    net['h3'].cmd('ip route add 192.168.1.0/24 via 172.16.0.1')
    net['h3'].cmd('ip route add 10.0.0.0/8 via 172.16.0.1')

    net['h4'].cmd('ip route add 192.168.1.0/24 via 172.16.0.1')
    net['h4'].cmd('ip route add 10.0.0.0/8 via 172.16.0.1')

    net['h5'].cmd('ip route add 192.168.1.0/24 via 10.0.0.1')
    net['h5'].cmd('ip route add 172.16.0.0/12 via 10.0.0.1')

    net['h6'].cmd('ip route add 192.168.1.0/24 via 10.0.0.1')
    net['h6'].cmd('ip route add 172.16.0.0/12 via 10.0.0.1')
